...
<style lang="scss">
@mixin frame-setting($pos, $top, $left) {
    position: $pos;
    top: $top;
    left: $left;
}
...
#banner1 {
    ...
    border-radius: 8px;
    @include frame-setting(absolute, 12vh, 5vw);
    @include widthHeight(90vw, 24vh);
}
#banner2 {
    border: 10px double blue;
    border-radius: 8px;
    @include widthHeight(88vw, 20vh);
...
#background-image{
    ...
    @include frame-setting(absolute, 25vh, 5vw);
    object-fit: fill;
}
.menuBar {
    @include frame-setting(absolute, 107vh, 5vw);
    @include widthHeight(90vw, null);
